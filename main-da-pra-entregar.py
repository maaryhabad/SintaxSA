...
class RoboAspirador:
    def __init__(self, pos_x, pos_y):
        ...
        self.bateria = 100
        self.ligado = False
        self.icon_original = pygame.image.load('assets/electronics/robot_vacuum_icon.png').convert_alpha()
...
class SmartLamp:
    def __init__(self, pos_x, pos_y):
        self.rect = pygame.Rect(pos_x - 40, pos_y - 40, 80, 80)
        self.ligado = False
        self.icon_original = pygame.image.load('assets/electronics/smart_lamp_icon.png').convert_alpha()
        self.icon = pygame.transform.scale(self.icon_original, (70, 70))
        self.icon_rect = self.icon.get_rect(center=self.rect.center)
...
class SmartSpeaker:
    def __init__(self, pos_x, pos_y):
        ...
        self.icon_original = pygame.image.load('assets/electronics/smart_speaker_icon.png').convert_alpha()
        self.icon = pygame.transform.scale(self.icon_original, (70, 70))
        self.icon_rect = self.icon.get_rect(center=self.rect.center)
